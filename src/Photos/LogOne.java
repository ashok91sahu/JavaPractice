...
public class LogOne {
	...
	public static void main(String[] args) {
		Logger log = LogManager.getLogger(LogOne.class.getName());
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Ak\\eclipse-workspace\\Log4j\\Driver\\chromedriver.exe");
